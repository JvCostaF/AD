...
# As duas funcoes abaixo funcionam, a primeira segue a ideia da inversa da CDF, como foi comentada em sala, a segunda usa um metodo da lib random do proprio Python
